...
public class GetLoginGoogleQueryHandler(IHttpContextAccessor httpContext) : IQueryHandler<Query.LoginGoogle, /*Response.Authenticated*/ string>
{
    public async Task<Result<string>> Handle(Query.LoginGoogle request, CancellationToken cancellationToken)
    {
